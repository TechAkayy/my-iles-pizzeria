      ...
      <div class="flex flex-wrap -mx-4">
        <div class="p-4 text-center w-full lg:w-4/12">
          ...
          <ul class="mb-4 space-y-1">
            ...
            <li>
              <a to="#" class="hover:text-color3-400 text-color3-500"
                >+0 123 456 7890</a
              >
            </li>
            <li>
          ...
          <div class="flex-wrap inline-flex space-x-3">
            <BaseButton to="#" aria-label="facebook" variant="link">
            ...
            <BaseButton to="#" aria-label="twitter" variant="link">
              <svg viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
                <path
            ...
            <BaseButton to="#" aria-label="instagram" variant="link">
              <svg viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
                <path
            ...
            <BaseButton to="#" aria-label="linkedin" variant="link">
              <svg viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
                <path
            ...
            <BaseButton to="#" aria-label="youtube" variant="link">
              <svg viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5">
                <path
        ...
        <div class="p-4 w-full md:w-6/12 lg:order-first lg:w-4/12">
          ...
          <div class="-mx-4 flex flex-wrap">
            <div class="pb-4 px-4 w-full sm:w-6/12">
              <ul>
                <li class="mb-4">
                  <BaseButton to="#" variant="ghost" color="neutral"
                    >FAQ</BaseButton
                  >
                </li>
                <li class="mb-4">
            ...
            <div class="pb-4 px-4 w-full sm:w-6/12">
              <ul>
                <li class="mb-4">
                  <BaseButton to="#" color="neutral" variant="ghost"
                    >Shop</BaseButton
                  >
                </li>
                <li class="mb-4">
      ...
      <div class="py-4">
        ...
        <div class="flex flex-wrap -mx-4 items-center">
          ...
          <div class="px-4 py-2 w-full md:w-auto">
            <BaseButton to="#" variant="ghost">Privacy Policy</BaseButton> |

            <BaseButton to="#" variant="ghost">Terms of Use</BaseButton>
          </div>
        </div>
      </div>
    </div>
